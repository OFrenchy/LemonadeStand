...
namespace LemonadeStand
{
    public static class UserInterface
    {
        ...
        public static void showWelcomeScreen(string playerName)
        {
            ...
            welcomeScreen = "Welcome to your Lemonade Stand, " + playerName + "! \n" +
            ...
            welcomeScreen = welcomeScreen + "\n" +
                ...
                "with their blessing and your promise of the occasional free glass of lemonade.  /n";
        ...
        {
            // temp variables for screen layout
            int forecastTemperature = 75;
            string forecastCondition = "mostly cloudy skies";
            // Construct the display of all the information the player needs to start
            string prepScreen ;
            prepScreen = "\n" +
                $"========== {player.name}'s Lemonade Stand ==========\n\n" +
                $"Today's forecast is {day.forecastTemperature} degrees and {day.forecastWeatherConditions} \n" +
            ...
            prepScreen = prepScreen + "\n" +
                ...
                $"your cost per pitcher is ${player.getCostPerPitcher() }, and   \n" +
            ...
            {
                prepScreen = prepScreen +
                $"{i + 4})  {player.inventory.ingredients[i].quantity} {player.inventory.ingredients[i].name} \n";
            }
